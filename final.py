...
#features = np.array([pred_beds, pred_baths, pred_area, mean_price_m2, priceMean, priceArea]).reshape(1, -1)
#prediction = predict(features)
#c2.write('Your Suggested Price is:', 12)  
c2.markdown(f"<div style='font-size: 64px;'>{priceMean}</div>", unsafe_allow_html=True)
