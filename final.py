...
#features = np.array([pred_beds, pred_baths, pred_area, median_price_m2, median_price_m2, median_price_m2]).reshape(1, -1)
prediction = predict(features)
#c2.write('Your Suggested Price is:', 12)  
c2.markdown(f"<div style='font-size: 64px;'>{pred_area}</div>", unsafe_allow_html=True)
