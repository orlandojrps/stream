...
teste = int(median_price_m2.values[0])

features = np.array([pred_beds, pred_baths, pred_area, 3566, pred_area, pred_area]).reshape(1, -1)
...
c2.markdown(f"<div style='font-size: 64px;'>{teste}</div>", unsafe_allow_html=True)
